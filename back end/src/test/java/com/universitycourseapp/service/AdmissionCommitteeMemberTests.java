  ...
  package com.universitycourseapp.service; import static
  org.junit.jupiter.api.Assertions.assertEquals; import static
  org.junit.jupiter.api.Assertions.assertIterableEquals; import static
 ...
 import com.universitycourseapp.entities.AdmissionCommitteeMember; import
  com.universitycourseapp.entities.Course;
import com.universitycourseapp.entities.Role;
import com.universitycourseapp.entities.User;
import
  com.universitycourseapp.exception.CommitteeMemberAlreadyExistException;
  import com.universitycourseapp.exception.CommitteeMemberNotFound; import
  com.universitycourseapp.exception.CourseNotFoundException; import
  com.universitycourseapp.repository.IAdmissionCommiteeMemberRepository;
  
  @SpringBootTest class AdmissionCommitteeMemberTests {
  
  @MockBean IAdmissionCommiteeMemberRepository repository;
  
  @Autowired IAdmissionCommitteeServiceImpl serviceobj;
  
  @Test
  
  @DisplayName("AddCommitteeMember") void addCommitteMemberTest() throws
  CommitteeMemberAlreadyExistException{ 
  ...
  @DisplayName("updateCommitteeMamber") void updateCommitteeMamberTest() throws
  CommitteeMemberAlreadyExistException{  
	  AdmissionCommitteeMember member = new  AdmissionCommitteeMember(); 
  User user = new User(1,"username","password",Role.ADMISSIONCOMMITTEEMEMBER);
member.setAdminName("Abc"); 
...
member.setUser(user);
  ...
  @DisplayName("viewCommitteeMember") void viewCommitteeMemberTest() throws
  CommitteeMemberNotFound, CommitteeMemberAlreadyExistException{
	  AdmissionCommitteeMember member = new  AdmissionCommitteeMember(); 
	  User user = new User(1,"username","password",Role.ADMISSIONCOMMITTEEMEMBER);
	member.setAdminName("Abc"); 
	member.setAdminContact("Abc@xyz.com");
...
@Test
  ...
  @DisplayName("viewAllCommitteeMembers") void viewAllCommitteMembersTest()
  throws CommitteeMemberNotFound { 
	  AdmissionCommitteeMember member = new  AdmissionCommitteeMember(); 
 ...
 member3.setUser(user3);
  ...
  memberlist.add(member); memberlist.add(member2); memberlist.add(member3);
